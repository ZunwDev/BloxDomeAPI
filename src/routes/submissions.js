...
export default async function (fastify) {
  ...
  fastify.post(`${DEFAULT_API_URL}/submissions/:id/approve`, submissionsController.approveSubmission);
  fastify.post(`${DEFAULT_API_URL}/submissions/:id/reject`, submissionsController.rejectSubmission);
